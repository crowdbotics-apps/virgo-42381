"""
Django settings for virgo_42381 project.
...
WSGI_APPLICATION = 'virgo_42381.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "virgo_42381 API",
    "DESCRIPTION": "API documentation for virgo_42381 App",
    "VERSION": "v1",
}
